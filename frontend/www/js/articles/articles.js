...
const SECTION_ALIASES = new Map([
  ...
  ['player spotlight', 'Player & Clan Spotlights'],
  ['clan spotlight', 'Player & Clan Spotlights'],
  ['settlement spotlight', 'Settlement Spotlights'],
  ['competitions', 'Tournaments & Competitions'],
  ['tournaments', 'Tournaments & Competitions'],
  ['quests', 'Quests & Bounties'],
  ['bounties', 'Quests & Bounties'],
