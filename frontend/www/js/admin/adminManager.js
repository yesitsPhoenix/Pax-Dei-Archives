...
export async function handleAdminAccess(user) {
    ...
    try {
        ...
        if (isAdmin) {
            ...
            allowedPages.add('ledger_management.html');
        }
...
const protectedPages = ['admin.html', 'publication_editor.html', 'categorize_items.html', 'ledger_management.html', 'edit_lore.html', 'edit_quest.html', 'panel.html', 'quest_flow.html', 'features.html'];
